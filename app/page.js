          ...
          {showUpdateForm && (
            <section className="fixed z-10 inset-0 overflow-y-auto">
              <article className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                <article className="fixed inset-0 transition-opacity" aria-hidden="true">
                ...
                <article className="inline-block align-bottom bg-white rounded-lg lg:min-w-[700px] text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                  <article className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <article className="flex items-center justify-between">
                      <h3 className="text-lg leading-6 font-bold text-gray-900">Update Scores</h3>
                      <Image
                      src={html}
                      alt='HTML Icon'
                      className='w-10 h-10'
